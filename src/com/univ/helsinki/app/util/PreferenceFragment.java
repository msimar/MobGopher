...
public abstract class PreferenceFragment extends Fragment implements
	...
	public View onCreateView(LayoutInflater paramLayoutInflater,
		...
		return paramLayoutInflater.inflate(R.layout.preference_list_fragment,
	...
	public void onStart() {
		super.onStart();
		PreferenceManagerCompat.setOnPreferenceTreeClickListener(
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		PreferenceManagerCompat.dispatchActivityResult(mPreferenceManager,
	...
	public void setPreferenceScreen(PreferenceScreen preferenceScreen) {
		if (PreferenceManagerCompat.setPreferences(mPreferenceManager,
	...
	public void addPreferencesFromIntent(Intent intent) {
		...
		setPreferenceScreen(PreferenceManagerCompat.inflateFromIntent(
	...
	public void addPreferencesFromResource(int preferencesResId) {
		...
		setPreferenceScreen(PreferenceManagerCompat.inflateFromResource(
